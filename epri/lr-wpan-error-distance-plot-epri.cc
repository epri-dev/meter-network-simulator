...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("minDistance", "minimum distance", minDistance);
    cmd.AddValue("maxDistance", "maximum distance", maxDistance);
    ...
    psrplot.SetExtra("set xrange ["+std::to_string(minDistance)+":"+std::to_string(maxDistance)+"]\n\
set yrange [0:1]\n\
set grid\n\
